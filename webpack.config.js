...
Encore.addEntry('style', './resources/css/style.css')

//Vendor Css Files
Encore.addEntry('bootstrap-icons', './resources/vendor/bootstrap-icons/bootstrap-icons.css')
Encore.addEntry('bootstrap', './resources/vendor/bootstrap/css/bootstrap.min.css')
Encore.addEntry('boxicons', './resources/vendor/boxicons/css/boxicons.min.css')
Encore.addEntry('quill-snow', './resources/vendor/quill/quill.snow.css')
Encore.addEntry('quill-buble', './resources/vendor/quill/quill.bubble.css')
Encore.addEntry('remixicon', './resources/vendor/remixicon/remixicon.css')
Encore.addEntry('simple-datatable', './resources/vendor/simple-datatables/style.css')

//Vendor Js Files
Encore.addEntry('quilljs', './resources/vendor/quill/quill.min.js')
Encore.addEntry('php-email-form', './resources/vendor/php-email-form/validate.js')
